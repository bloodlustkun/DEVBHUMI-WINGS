  ...
  const features = [
    {
      icon: Mountain,
      title: "Expert Guides",
      description: "Professional and experienced local guides who know every trail and temple",
    },
    {
      icon: Heart,
      title: "Spiritual Journey",
      description: "Connect with ancient wisdom and find inner peace in sacred destinations",
    },
    {
      icon: Award,
    ...
    },
    {
      icon: Users,
      title: "Community",
      description: "Join a community of travelers seeking authentic experiences",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We are passionate about sharing the incredible beauty and spirituality of Uttarakhand 
            with travelers from around the world. Every journey is crafted with care and authenticity.
          </p>
        </motion.div>
